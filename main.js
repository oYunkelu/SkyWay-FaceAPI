...
const FACE_API_ENDPOINT =
  "https://yuuhatsu.cognitiveservices.azure.com/face/v1.0/detect";
...
$(() => {
  ...
  let indicateResult = (results) => {
    ...
    $("#contempt")
      .text(decimalFormat(contempt * 100))
      .css({
        width: contempt * 100 + "%",
        color: "black"
      });
    ...
    $("#disgust")
      .text(decimalFormat(disgust * 100))
      .css({
        width: disgust * 100 + "%",
        color: "black"
      });
    ...
    $("#happiness")
      .text(decimalFormat(happiness * 100))
      .css({
        width: happiness * 100 + "%",
        color: "black"
      });
    ...
    $("#neutral")
      .text(decimalFormat(neutral * 100))
      .css({
        width: neutral * 100 + "%",
        color: "black"
      });
    ...
    $("#sadness")
      .text(decimalFormat(sadness * 100))
      .css({
        width: sadness * 100 + "%",
        color: "black"
      });
    ...
    $("#surprise")
      .text(decimalFormat(surprise * 100))
      .css({
        width: surprise * 100 + "%",
        color: "black"
      });
